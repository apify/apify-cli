...
1. Choose where to keep the source code of your Actor: on your machine, or hosted on GitHub, GitLab, or Bitbucket. Let's choose **Local only** so the code stays on your machine.
