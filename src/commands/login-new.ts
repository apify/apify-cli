...
export class LoginNewCommand extends ApifyCommand<typeof LoginNewCommand> {
    static override description = 'Logs in to your Apify account using your API token.\nThe API token and other account '
