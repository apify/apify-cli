...
import { inputFilePath } from '../../__setup__/test-data/paths.js';

const ACTOR_NAME = useUniqueId('cli-call');
...
const expectedInputFile = JSON.parse(readFileSync(inputFilePath, 'utf-8'));
...
describe('[api] apify call', () => {
	...
	// TODO: move this to e2e tests, much easier to test
